<template>
    <button type="button" :class="buttonClasses" :style="buttonStyles" @click="scrollToTop" id="scrollTopBtn">
  ...
  <style lang="scss" scoped>
      #scrollTopBtn {
          bottom: 1rem;
          right: 1rem;
          transition: opacity .3s ease-in-out, visibility .3s ease-in-out, transform .2s ease-in-out, background-color .3s ease-in-out;
      }
  </style>
