<template>
    <div class="input-container mb-3 md:mb-5">
      <input
        ...
        :class="['text-tertiary-grey h-input-mobile md:h-input bg-transparent placeholder:text-tertiary-grey focus:outline-none border-b w-full text-sm md:text-base', { 'border-base-red': error, 'border-secondary-grey': !error }]"
      />
